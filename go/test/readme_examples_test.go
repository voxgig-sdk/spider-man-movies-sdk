...
const testSeed = `map[string]any{"entity": map[string]any{"justwatch": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "media": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "photo": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "search": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
