...
func NewJustwatchEntity(client *core.SpiderManMoviesSDK, entopts map[string]any) *JustwatchEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *JustwatchEntity) GetName() string { return e.name }
...
func (e *JustwatchEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *JustwatchEntity) Deleted() bool {
	return e.deleted
}


func (e *JustwatchEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewJustwatchEntity(e.client, opts)
}

func (e *JustwatchEntity) Data(args ...any) any {
...
func (e *JustwatchEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *JustwatchEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *JustwatchEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *JustwatchEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *JustwatchEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *JustwatchEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *JustwatchEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
