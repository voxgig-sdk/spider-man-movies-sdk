...
func NewMediaEntity(client *core.SpiderManMoviesSDK, entopts map[string]any) *MediaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MediaEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
