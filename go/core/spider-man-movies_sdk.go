...
type SpiderManMoviesSDK struct {
	Mode     string
...
func (sdk *SpiderManMoviesSDK) OptionsMap() map[string]any {
...
func (sdk *SpiderManMoviesSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *SpiderManMoviesSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *SpiderManMoviesSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *SpiderManMoviesSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *SpiderManMoviesSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *SpiderManMoviesSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("SpiderManMoviesSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *SpiderManMoviesSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *SpiderManMoviesSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("SpiderManMoviesSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *SpiderManMoviesSDK {
	...
	sdk := NewSpiderManMoviesSDK(sdkopts)
	sdk.Mode = "test"
