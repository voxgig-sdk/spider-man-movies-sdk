...
// SpiderManMovies SDK utility type

class SpiderManMoviesUtility
{
    ...
    public static function copy(SpiderManMoviesUtility $src): SpiderManMoviesUtility
    {
        $u = new SpiderManMoviesUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
