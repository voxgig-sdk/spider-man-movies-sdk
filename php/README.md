# SpiderManMovies PHP SDK



The PHP SDK for the SpiderManMovies API — an entity-oriented client using PHP conventions.
...
```
php/
├── spidermanmovies_sdk.php          -- Main SDK class
...
The main class (`spidermanmovies_sdk.php`) exports the SDK class
