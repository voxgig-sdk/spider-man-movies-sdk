...
The PHP SDK for the SpiderManMovies API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Justwatch(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->SpiderManMovies(null)->load(
    ["id" => "test01"], null
);
