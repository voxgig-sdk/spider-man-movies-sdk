...
// SpiderManMovies SDK telemetry feature
...
class SpiderManMoviesTelemetryFeature extends SpiderManMoviesBaseFeature
{
    ...
    private function _close(SpiderManMoviesContext $ctx, bool $ok): void
    {
