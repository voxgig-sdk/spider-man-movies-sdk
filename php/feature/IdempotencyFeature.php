...
// SpiderManMovies SDK idempotency feature
...
class SpiderManMoviesIdempotencyFeature extends SpiderManMoviesBaseFeature
{
    ...
    private function _mutating(SpiderManMoviesContext $ctx): bool
    {
