...
// SpiderManMovies SDK ratelimit feature
...
class SpiderManMoviesRatelimitFeature extends SpiderManMoviesBaseFeature
{
    ...
    private function _acquire(SpiderManMoviesContext $ctx): void
    {
    ...
    private function _track(SpiderManMoviesContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
