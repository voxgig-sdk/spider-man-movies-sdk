...
// SpiderManMovies SDK debug feature
...
class SpiderManMoviesDebugFeature extends SpiderManMoviesBaseFeature
{
    ...
    private function _finish(SpiderManMoviesContext $ctx, bool $ok): void
    {
