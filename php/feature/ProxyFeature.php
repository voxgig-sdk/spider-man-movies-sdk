...
// SpiderManMovies SDK proxy feature
...
class SpiderManMoviesProxyFeature extends SpiderManMoviesBaseFeature
{
    ...
    public function init(SpiderManMoviesContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (SpiderManMoviesContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
