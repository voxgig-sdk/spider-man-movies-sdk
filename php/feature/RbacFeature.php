...
// SpiderManMovies SDK rbac feature
...
class SpiderManMoviesRbacFeature extends SpiderManMoviesBaseFeature
{
    ...
    private function _required(SpiderManMoviesContext $ctx): ?string
    {
    ...
    private function _reject(SpiderManMoviesContext $ctx, string $required): void
    {
    ...
    private function _track(SpiderManMoviesContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
