...
// SpiderManMovies SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class SpiderManMoviesTransformResponse
{
    public static function call(SpiderManMoviesContext $ctx): mixed
    {
        ...
        $transform = SpiderManMoviesHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
