...
// SpiderManMovies SDK utility: result_basic

class SpiderManMoviesResultBasic
{
    public static function call(SpiderManMoviesContext $ctx): ?SpiderManMoviesResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof SpiderManMoviesError) ? $result->err->msg : (string)$result->err;
