...
// SpiderManMovies SDK Media entity
...
class MediaEntity
{
     ...
     * Load a single Media.
     *
     * @param MediaLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MediaLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Media|array The loaded Media as an assoc-array at the
