...
// SpiderManMovies SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (SpiderManMoviesSDK::test)
...
{
    private const SDK_CLASS = 'SpiderManMoviesSDK';
    ...
    private const SDK_BASE = 'spidermanmovies_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../spidermanmovies_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
