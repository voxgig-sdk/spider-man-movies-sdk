...
class MediaDirectTest extends TestCase
{
    public function test_direct_load_media(): void
    {
        $setup = media_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-media", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
