...
class SpiderManMoviesTestRunner
{
    ...
    {
        $live = self::getenv('SPIDER_MAN_MOVIES_TEST_LIVE');
        $override = self::getenv('SPIDER_MAN_MOVIES_TEST_OVERRIDE');
        ...
        $explain = self::getenv('SPIDER_MAN_MOVIES_TEST_EXPLAIN');
...
class_alias('SpiderManMoviesTestRunner', 'Runner');
class_alias('SpiderManMoviesHelpers', 'Helpers');
