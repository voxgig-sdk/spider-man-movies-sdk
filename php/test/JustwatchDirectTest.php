...
class JustwatchDirectTest extends TestCase
{
    public function test_direct_load_justwatch(): void
    {
        $setup = justwatch_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-justwatch", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
