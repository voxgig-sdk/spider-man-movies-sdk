...
// SpiderManMovies SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = SpiderManMoviesOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(SpiderManMoviesOmni::structfix($now, Struct::undef()))
                        !== json_encode(SpiderManMoviesOmni::structfix($val, Struct::undef()))) {
