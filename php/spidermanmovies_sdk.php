...
class SpiderManMoviesSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = SpiderManMoviesHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = SpiderManMoviesHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!SpiderManMoviesFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, SpiderManMoviesFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return SpiderManMoviesUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = SpiderManMoviesHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = SpiderManMoviesHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = SpiderManMoviesHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new SpiderManMoviesError($op . "_allow",
                "SpiderManMoviesSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = SpiderManMoviesHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new SpiderManMoviesError("graphql_error",
                "SpiderManMoviesSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Justwatch($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_justwatch === null) {
                $this->_justwatch = new JustwatchEntity($this, null);
            }
            return $this->_justwatch;
        }
        return new JustwatchEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new SpiderManMoviesSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
