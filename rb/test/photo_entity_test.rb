...
class PhotoEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set SPIDER_MAN_MOVIES_TEST_PHOTO_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def photo_basic_setup(extra)
  ...
  entid_env_raw = ENV["SPIDER_MAN_MOVIES_TEST_PHOTO_ENTID"]
