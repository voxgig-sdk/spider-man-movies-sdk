...
#      offline in seeded test mode (SpiderManMoviesSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "SpiderManMovies_sdk.rb")
  SDK_CLASS = "SpiderManMoviesSDK"
