// Command SpiderManMovies-cli is a CLI + REPL for the SpiderManMovies SDK,
...
const prompt = "spider-man-movies"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "justwatch media photo search"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      SPIDER_MAN_MOVIES_APIKEY (api key), SPIDER_MAN_MOVIES_BASE (base url override)")
