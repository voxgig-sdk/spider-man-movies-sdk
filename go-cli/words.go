...
func registerSDKWords(r *eng.Registry, client *sdk.SpiderManMoviesSDK) {
...
func runOp(client *sdk.SpiderManMoviesSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
