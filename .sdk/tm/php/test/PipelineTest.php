...
// SpiderManMovies SDK pipeline test
//
...
{
    private static function utility(): SpiderManMoviesUtility
    {
        return new SpiderManMoviesUtility();
    }
    ...
    private static function ctx(array $over = []): SpiderManMoviesContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new SpiderManMoviesContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new SpiderManMoviesOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof SpiderManMoviesError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new SpiderManMoviesOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = SpiderManMoviesMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new SpiderManMoviesOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = SpiderManMoviesMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new SpiderManMoviesOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = SpiderManMoviesMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new SpiderManMoviesSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = SpiderManMoviesMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new SpiderManMoviesResponse([]),
            'result' => new SpiderManMoviesResult([]),
        ]);
        [, $err] = SpiderManMoviesMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new SpiderManMoviesSpec([]),
            'response' => null,
            'result' => new SpiderManMoviesResult([]),
        ]);
        [, $err] = SpiderManMoviesMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new SpiderManMoviesSpec(['step' => 's']),
            'response' => new SpiderManMoviesResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new SpiderManMoviesResult([]),
        ]);
        [, $err] = SpiderManMoviesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new SpiderManMoviesSpec(['step' => 's']),
            'response' => new SpiderManMoviesResponse(self::resp(200, ['v' => 1])),
            'result' => new SpiderManMoviesResult([]),
        ]);
        [, $err] = SpiderManMoviesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new SpiderManMoviesSpec(['step' => 's']),
            'response' => new SpiderManMoviesResponse(self::resp(200, ['v' => 2])),
            'result' => new SpiderManMoviesResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        SpiderManMoviesMakeResponse::call($ctx);
    ...
    {
        $preset = new SpiderManMoviesResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new SpiderManMoviesSpec([]),
            'response' => new SpiderManMoviesResponse([]),
            'result' => new SpiderManMoviesResult([]),
        ...
        [$got, $err] = SpiderManMoviesMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new SpiderManMoviesResult([])]);
        [, $err] = SpiderManMoviesMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new SpiderManMoviesSpec([]), 'result' => null]);
        [, $err] = SpiderManMoviesMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new SpiderManMoviesSpec(['step' => 's']),
            'result' => new SpiderManMoviesResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new SpiderManMoviesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = SpiderManMoviesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new SpiderManMoviesSpec(['step' => 's']),
            'result' => new SpiderManMoviesResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new SpiderManMoviesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = SpiderManMoviesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new SpiderManMoviesResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new SpiderManMoviesSpec([]),
            'result' => new SpiderManMoviesResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = SpiderManMoviesMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = SpiderManMoviesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new SpiderManMoviesError('boom', 'boom');
        $utility->fetcher = function (SpiderManMoviesContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new SpiderManMoviesSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = SpiderManMoviesMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (SpiderManMoviesContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = SpiderManMoviesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(SpiderManMoviesResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        SpiderManMoviesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (SpiderManMoviesContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new SpiderManMoviesSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = SpiderManMoviesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new SpiderManMoviesResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new SpiderManMoviesSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = SpiderManMoviesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = SpiderManMoviesMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = SpiderManMoviesMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new SpiderManMoviesResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, SpiderManMoviesDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new SpiderManMoviesResult(['ok' => false])]);
        $this->expectException(SpiderManMoviesError::class);
        SpiderManMoviesDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new SpiderManMoviesResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', SpiderManMoviesMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        SpiderManMoviesMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new SpiderManMoviesBaseFeature();
        $b = new SpiderManMoviesBaseFeature();
        SpiderManMoviesFeatureAdd::call($ctx, $a);
        SpiderManMoviesFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): SpiderManMoviesBaseFeature
    {
        $f = new SpiderManMoviesBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        SpiderManMoviesFeatureAdd::call($ctx, self::named_feature('a'));
        SpiderManMoviesFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        SpiderManMoviesFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        SpiderManMoviesFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        SpiderManMoviesFeatureAdd::call($ctx, $replace);
        ...
        SpiderManMoviesFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): SpiderManMoviesContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new SpiderManMoviesSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = SpiderManMoviesPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        SpiderManMoviesPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new SpiderManMoviesResponse(['headers' => null]),
            'result' => new SpiderManMoviesResult([]),
        ]);
        SpiderManMoviesResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        SpiderManMoviesResultBody::call($ctx);
