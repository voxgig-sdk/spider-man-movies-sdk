...
// SpiderManMovies SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class SpiderManMoviesMakeRequest
{
    public static function call(SpiderManMoviesContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new SpiderManMoviesResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new SpiderManMoviesResponse($fetched);
        } else {
