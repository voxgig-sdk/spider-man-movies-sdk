...
// SpiderManMovies SDK utility: graphql
//
...
class SpiderManMoviesGraphql
{
    ...
    // equivalent.
    public static function body(SpiderManMoviesContext $ctx): mixed
    {
    ...
    public static function errors(SpiderManMoviesContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
