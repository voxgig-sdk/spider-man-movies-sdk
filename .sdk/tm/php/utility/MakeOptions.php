...
// SpiderManMovies SDK utility: make_options

class SpiderManMoviesMakeOptions
{
    ...
    public static function call(SpiderManMoviesContext $ctx): array
    {
        ...
        //
        // `SpiderManMoviesSchema::optspec()` is built from the model:
        ...
        $optspec = SpiderManMoviesSchema::optspec();
