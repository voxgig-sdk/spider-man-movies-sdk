...
// SpiderManMovies SDK utility: fetcher

class SpiderManMoviesFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; SpiderManMoviesSDK/1.0)';
    ...
    public static function call(SpiderManMoviesContext $ctx, string $fullurl, array $fetchdef): array
    {
