...
// SpiderManMovies SDK audit feature
...
class SpiderManMoviesAuditFeature extends SpiderManMoviesBaseFeature
{
    ...
    private function _emit(SpiderManMoviesContext $ctx, string $outcome): void
    {
