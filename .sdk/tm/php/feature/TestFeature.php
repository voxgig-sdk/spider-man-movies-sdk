...
// SpiderManMovies SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class SpiderManMoviesTestFeature extends SpiderManMoviesBaseFeature
{
    ...
    public function init(SpiderManMoviesContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (SpiderManMoviesContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = SpiderManMoviesParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (SpiderManMoviesContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(SpiderManMoviesContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = SpiderManMoviesParam::call($ctx, $k);
