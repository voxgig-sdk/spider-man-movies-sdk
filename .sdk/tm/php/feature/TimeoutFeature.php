...
// SpiderManMovies SDK timeout feature
...
class SpiderManMoviesTimeoutFeature extends SpiderManMoviesBaseFeature
{
    ...
    private function _with_timeout(SpiderManMoviesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(SpiderManMoviesContext $_ctx, float $ms): void
    {
        $client = $this->client;
