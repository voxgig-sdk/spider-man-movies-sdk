...
// SpiderManMovies SDK streaming feature
...
class SpiderManMoviesStreamingFeature extends SpiderManMoviesBaseFeature
{
    ...
    private function _iterate(SpiderManMoviesResult $result): \Generator
    {
    ...
    private function _streamable(SpiderManMoviesContext $ctx): bool
    {
