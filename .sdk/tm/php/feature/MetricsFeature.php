...
// SpiderManMovies SDK metrics feature
...
class SpiderManMoviesMetricsFeature extends SpiderManMoviesBaseFeature
{
    ...
    private function _record(SpiderManMoviesContext $ctx, bool $ok): void
    {
