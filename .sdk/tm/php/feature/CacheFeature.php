...
// SpiderManMovies SDK cache feature
...
class SpiderManMoviesCacheFeature extends SpiderManMoviesBaseFeature
{
    ...
    private function _through(SpiderManMoviesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
