...
// SpiderManMovies SDK clienttrack feature
...
class SpiderManMoviesClienttrackFeature extends SpiderManMoviesBaseFeature
{
    ...
    public function PostConstruct(SpiderManMoviesContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'SpiderManMovies-SDK';
