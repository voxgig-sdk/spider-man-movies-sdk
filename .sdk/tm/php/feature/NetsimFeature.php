...
// SpiderManMovies SDK netsim feature
...
class SpiderManMoviesNetsimFeature extends SpiderManMoviesBaseFeature
{
    ...
    private function _simulate(SpiderManMoviesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(SpiderManMoviesContext $ctx, array $applied): void
    {
        $client = $this->client;
