...
class SpiderManMoviesTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = SpiderManMoviesTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = SpiderManMoviesTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = SpiderManMoviesTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
