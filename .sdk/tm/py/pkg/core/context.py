...
from projectname_sdk.core.control import SpiderManMoviesControl
...
class SpiderManMoviesContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = SpiderManMoviesControl()
        ...
        if isinstance(sp, SpiderManMoviesSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, SpiderManMoviesResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, SpiderManMoviesResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return SpiderManMoviesOperation({})
    ...
    def make_error(self, code, msg):
        return SpiderManMoviesError(code, msg, self)
