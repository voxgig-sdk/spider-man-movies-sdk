...
|---|---|---|
| `ts/` | @voxgig-sdk/spider-man-movies-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/spider-man-movies-sdk \
      --repository voxgig-sdk/spider-man-movies-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/spider-man-movies-sdk` shows it, and
`npm trust revoke @voxgig-sdk/spider-man-movies-sdk --id=<id>` removes it.
