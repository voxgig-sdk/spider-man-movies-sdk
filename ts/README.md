...
The TypeScript SDK for the SpiderManMovies API. Provides a type-safe, entity-oriented interface with full async/await support.
...
```ts
const client = new SpiderManMoviesSDK({ apikey: '...' })
