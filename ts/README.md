# SpiderManMovies TypeScript SDK



The TypeScript SDK for the SpiderManMovies API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Justwatch()` — each with a small set of operations (`load`)
...
```ts
new SpiderManMoviesSDK(options?: {
  base?: string
  prefix?: string
  suffix?: string
...
| `tester(testopts?, sdkopts?)` | `SpiderManMoviesSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `SpiderManMoviesSDK.test(testopts?, sdkopts?)` | `SpiderManMoviesSDK` | Create a test-mode client. |
...
spider-man-movies/
├── src/
│   ├── SpiderManMoviesSDK.ts        # Main SDK class
