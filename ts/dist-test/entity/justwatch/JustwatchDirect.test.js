...
(0, node_test_1.describe)('JustwatchDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.SpiderManMoviesSDK({
    ...
    (0, node_test_1.test)('direct-load-justwatch', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-justwatch', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.SPIDER_MAN_MOVIES_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.SpiderManMoviesSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['SPIDER_MAN_MOVIES_TEST_JUSTWATCH_ENTID'];
    ...
    const client = new __1.SpiderManMoviesSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=JustwatchDirect.test.js.map