...
(0, node_test_1.describe)('MediaDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-media', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-media', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['SPIDER_MAN_MOVIES_TEST_MEDIA_ENTID'];
...
//# sourceMappingURL=MediaDirect.test.js.map