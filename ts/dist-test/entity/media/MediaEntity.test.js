...
(0, node_test_1.describe)('MediaEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        let media_ref01_data = Object.values(setup.data.existing.media)[0];
        // LOAD
        const media_ref01_ent = client.Media();
        const media_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(media_ref01_data_dt0.id === media_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['SPIDER_MAN_MOVIES_TEST_MEDIA_ENTID'];
