...
exports.SpiderManMoviesEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends SpiderManMoviesEntityBase<Advice>`.
class SpiderManMoviesEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.SpiderManMoviesEntityBase = SpiderManMoviesEntityBase;
//# sourceMappingURL=SpiderManMoviesEntityBase.js.map