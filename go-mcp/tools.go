...
type Args struct {
	Entity string         `json:"entity" jsonschema:"justwatch | media | photo | search"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.SpiderManMoviesSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "spider-man-movies_list",
		Description: "List records from SpiderManMovies. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "spider-man-movies_load",
		Description: "Load a single record from SpiderManMovies. " +
...
func runOp(client *sdk.SpiderManMoviesSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.SpiderManMoviesSDK, name string) (sdk.SpiderManMoviesEntity, error) {
	switch strings.ToLower(name) {
	case "justwatch":
		return client.Justwatch(nil), nil
	case "media":
