// Command SpiderManMovies-mcp is an MCP server exposing the SpiderManMovies
// SDK as MCP tools.
//
// Two tools are registered:
//
//	SpiderManMovies_list  — list records of an entity
//	SpiderManMovies_load  — load a single record of an entity
//
