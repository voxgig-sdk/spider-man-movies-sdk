...
local JustwatchEntity = {}
JustwatchEntity.__index = JustwatchEntity


function JustwatchEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, JustwatchEntity)
  self._name = "justwatch"
  self._client = client
...
function JustwatchEntity:get_name()
  return self._name
end


function JustwatchEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return JustwatchEntity.new(self._client, opts)
end
...
function JustwatchEntity:mark_deleted()
  self._deleted = true
end


function JustwatchEntity:deleted()
  return true == self._deleted
end


function JustwatchEntity:data_set(args)
  if args ~= nil then
...
function JustwatchEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function JustwatchEntity:match_set(args)
  if args ~= nil then
...
function JustwatchEntity:match_get()
...
function JustwatchEntity:stream(action, args, callopts)
...
---@param reqmatch JustwatchLoadMatch
---@param ctrl? table
---@return Justwatch
---@return string? err
function JustwatchEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function JustwatchEntity:_run_op(ctx, post_done)
  local utility = self._utility
