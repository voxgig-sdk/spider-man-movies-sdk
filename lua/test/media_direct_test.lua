...
describe("MediaDirect", function()
  it("should direct-load-media", function()
    local setup = media_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-media", setup.live and "live" or "unit")
...
function media_direct_setup(mockres)
