...
describe("JustwatchDirect", function()
  it("should direct-load-justwatch", function()
    local setup = justwatch_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-justwatch", setup.live and "live" or "unit")
...
function justwatch_direct_setup(mockres)
