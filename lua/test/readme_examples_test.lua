...
local SDK_MODULE = "spider-man-movies_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["justwatch"] = { ["test01"] = { id = "test01" } }, ["media"] = { ["test01"] = { id = "test01" } }, ["photo"] = { ["test01"] = { id = "test01" } }, ["search"] = { ["test01"] = { id = "test01" } } } }'
