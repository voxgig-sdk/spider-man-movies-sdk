# SpiderManMovies SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions SpiderManMoviesSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both SpiderManMoviesSDK(...) and SpiderManMoviesSDK.test(...) become
#      SpiderManMoviesSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "spidermanmovies_sdk"
_SDK_CLASS = "SpiderManMoviesSDK"
