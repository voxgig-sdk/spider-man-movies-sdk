...
from spidermanmovies_sdk.utility import register

# Load features
from spidermanmovies_sdk.feature.base_feature import SpiderManMoviesBaseFeature
from spidermanmovies_sdk.features import _has_feature, _make_feature
...
class SpiderManMoviesSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = SpiderManMoviesUtility()
        self._utility = utility

        from spidermanmovies_sdk.config import shared_config
    ...
    def get_utility(self):
        return SpiderManMoviesUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("SpiderManMoviesSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Justwatch(self, data=None) -> "JustwatchEntity":
        ...
        from spidermanmovies_sdk.entity.justwatch_entity import JustwatchEntity
    ...
    def Media(self, data=None) -> "MediaEntity":
        ...
        from spidermanmovies_sdk.entity.media_entity import MediaEntity
        return MediaEntity(self, data)


    def Photo(self, data=None) -> "PhotoEntity":
        """Entity factory: client.Photo().list() / client.Photo().load({"id": ...})."""
        from spidermanmovies_sdk.entity.photo_entity import PhotoEntity
        return PhotoEntity(self, data)


    def Search(self, data=None) -> "SearchEntity":
        """Entity factory: client.Search().list() / client.Search().load({"id": ...})."""
        from spidermanmovies_sdk.entity.search_entity import SearchEntity
        return SearchEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "SpiderManMoviesSDK":
        if sdkopts is None:
            sdkopts = {}
