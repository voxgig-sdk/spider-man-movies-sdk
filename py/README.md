# SpiderManMovies Python SDK



The Python SDK for the SpiderManMovies API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Justwatch()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/spider-man-movies-sdk/releases)) or
...
```
py/
├── spidermanmovies_sdk.py         -- Main SDK module
